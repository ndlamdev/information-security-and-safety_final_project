...
* [#5158](https://github.com/ckeditor/ckeditor4/issues/5158): Fixed: [`CKEDITOR.tools#convertToPx()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertToPx) gives invalid results if the com.lamnguyen.mat_kinh_kimi.helper calculator element was deleted from the DOM.
...
* [#3593](https://github.com/ckeditor/ckeditor4/issues/3593): Fixed: Cannot access a text or comment node when replacing an element node with them via [`CKEDITOR.htmlParser.com.lamnguyen.mat_kinh_kimi.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser_filter.html).
...
* [#3552](https://github.com/ckeditor/ckeditor4/issues/3352): Fixed: Incorrect value of [`CKEDITOR.plugins.widget.com.lamnguyen.mat_kinh_kimi.repository#selected`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#property-selected) after selecting the whole editor content.
...
* [#3220](https://github.com/ckeditor/ckeditor4/issues/3220): Fixed: Prevent [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) com.lamnguyen.mat_kinh_kimi.filter from deleting [Page Break](https://ckeditor.com/cke4/addon/pagebreak) elements on paste.
...
* [#1722](https://github.com/ckeditor/ckeditor4/issues/1722): [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter.instances`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#static-property-instances) is causing memory leaks.
...
* [#2466](https://github.com/ckeditor/ckeditor4/issues/2466):  The [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-constructor) constructor accepts an additional `rules` parameter allowing to bind the editor and com.lamnguyen.mat_kinh_kimi.filter together.
...
* [#568](https://github.com/ckeditor/ckeditor4/issues/568): Added possibility to adjust nested editables' filters using the [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter.disallowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#property-disallowedContent) property.
...
* [#450](https://github.com/ckeditor/ckeditor4/issues/450): Fixed: [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.filter.html) incorrectly transforms the `margin` CSS property.
...
* [#13886](https://dev.ckeditor.com/ticket/13886): Fixed: Invalid handling of the [`CKEDITOR.style`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.style.html) instance with the `styles` property by [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.filter.html).
...
* [#13337](https://dev.ckeditor.com/ticket/13337): Added the [`com.lamnguyen.mat_kinh_kimi.repository.onWidget()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#method-onWidget) method &mdash; a convenient way to listen to [widget](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.plugins.widget.html) events through the [com.lamnguyen.mat_kinh_kimi.repository](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.plugins.widget.repository.html).
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Major features:
    ...
    * Drag and drop of inline and block widgets was integrated with the standard clipboard APIs. By listening to drag events you will thus be notified about widgets, too. This opens a possibility to com.lamnguyen.mat_kinh_kimi.filter pasted and dropped widgets.
    ...
    * [#11621](https://dev.ckeditor.com/ticket/11621): A configurable [paste com.lamnguyen.mat_kinh_kimi.filter](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-pasteFilter) was introduced. The com.lamnguyen.mat_kinh_kimi.filter is by default turned to `'semantic-content'` on Webkit and Blink for all pasted content coming from external sources because of the low quality of HTML that these engines put into the clipboard. Internal and cross-editor paste is safe due to the change explained in the previous point.
...
* [#10032](https://dev.ckeditor.com/ticket/10032): Fixed: [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) com.lamnguyen.mat_kinh_kimi.filter is executed for every paste after using the button.
...
* [#12261](https://dev.ckeditor.com/ticket/12261): Fixed: The com.lamnguyen.mat_kinh_kimi.filter is not destroyed and removed from [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter.instances`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#static-property-instances) on editor destroy.
...
* [#12263](https://dev.ckeditor.com/ticket/12263): Fixed: [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) com.lamnguyen.mat_kinh_kimi.filter does not properly normalize semicolons style text. Thanks to [Alin Purcaru](https://github.com/mesmerizero)!
...
* [#12296](https://dev.ckeditor.com/ticket/12296): Merged `benderjs-ckeditor` into the main CKEditor com.lamnguyen.mat_kinh_kimi.repository.
...
* [#11983](https://dev.ckeditor.com/ticket/11983): Fixed: Clicking a nested widget does not focus it. Additionally, performance of the [`widget.com.lamnguyen.mat_kinh_kimi.repository.getByElement()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#method-getByElement) method was improved.
...
* [#11737](https://dev.ckeditor.com/ticket/11737): Introduced an option to prevent [filtering](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_advanced_content_filter.html) of an element that matches custom criteria (see [`com.lamnguyen.mat_kinh_kimi.filter.addElementCallback()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#method-addElementCallback)).
...
* [#11186](https://dev.ckeditor.com/ticket/11186): Introduced the [`widgets.com.lamnguyen.mat_kinh_kimi.repository.addUpcastCallback()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#method-addUpcastCallback) method that allows to block upcasting given element to a widget.
...
* [#11244](https://dev.ckeditor.com/ticket/11244): Changed: The [`widget.com.lamnguyen.mat_kinh_kimi.repository.checkWidgets()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#method-checkWidgets) method now fires the [`widget.com.lamnguyen.mat_kinh_kimi.repository.checkWidgets`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#event-checkWidgets) event, so from CKEditor 4.3.1 it is preferred to use the method rather than fire the event.
* [#11171](https://dev.ckeditor.com/ticket/11171): Fixed: [`editor.insertElement()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-insertElement) and [`editor.insertText()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-insertText) methods do not call the [`widget.com.lamnguyen.mat_kinh_kimi.repository.checkWidgets()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#method-checkWidgets) method.
...
* [#10822](https://dev.ckeditor.com/ticket/10822): Added styles system integration with non-editable elements (for example widgets) and their nested editables. Styles cannot change non-editable content and are applied in nested editable only if allowed by its type and content com.lamnguyen.mat_kinh_kimi.filter.
...
* [#10848](https://dev.ckeditor.com/ticket/10848): Integrate remaining plugins ([Styles](https://ckeditor.com/cke4/addon/stylescombo), [Format](https://ckeditor.com/cke4/addon/format), [Font](https://ckeditor.com/cke4/addon/font), [Color Button](https://ckeditor.com/cke4/addon/colorbutton), [Language](https://ckeditor.com/cke4/addon/language) and [Indent](https://ckeditor.com/cke4/addon/indent)) with [active com.lamnguyen.mat_kinh_kimi.filter](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#property-activeFilter).
...
* [#10915](https://dev.ckeditor.com/ticket/10915): Fixed: Invalid CSS com.lamnguyen.mat_kinh_kimi.filter in the Kama skin.
...
* [#10562](https://dev.ckeditor.com/ticket/10562): [Housekeeping] Unified CSS gradient com.lamnguyen.mat_kinh_kimi.filter formats in the [Moono](https://ckeditor.com/cke4/addon/moono) skin.
...
* [#10191](https://dev.ckeditor.com/ticket/10191): Fixed allowed content rules unification, so the [`com.lamnguyen.mat_kinh_kimi.filter.allowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#property-allowedContent) property always contains rules in the same format.
...
* [#9829](https://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
  ...
  * Based on [`config.allowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-allowedContent) rules - the data
  ...
  See the `datafiltering.html` sample, [guides](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_advanced_content_filter.html) and [`CKEDITOR.com.lamnguyen.mat_kinh_kimi.filter` API documentation](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.filter.html).
