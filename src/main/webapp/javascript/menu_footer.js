                            ...
                            <ul class="navbar-nav m-auto">
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=1&id-category=1&page=1">
                                                Kính mát nam
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=1&id-category=2&page=1">
                                                Kính mát nữ
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=1&id-category=3&page=1">
                                                Kính đi ngày và đêm
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=1&id-category=4&page=1">
                                                Kính đổi màu
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=1&id-category=5&page=1">
                                                Kính lọc ánh sáng xanh
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"  href="product-booth?id-category-group=1&id-category=6&page=1">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=2&id-category=7&page=1">
                                                Gọng Kính Trẻ Em
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=2&id-category=8&page=1">
                                                Kính Mát Trẻ Em
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=3&id-category=9&page=1">
                                                Gọng kính nữa khung
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=3&id-category=10&page=1">
                                            Gọng kính khoan
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=3&id-category=11&page=1">
                                                Gọng kính tròn
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=3&id-category=12&page=1">
                                                Gọng kính titan
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=4&id-category=13&page=1">
                                               Tròng kính chống ánh sáng xanh
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=4&id-category=14&page=1">Tròng
                                                kính đổi màu
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=4&id-category=15&page=1">Tròng
                                                kính màu
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="product-booth?id-category-group=4&id-category=16&page=1">
                                                Tròng kính cho gọng khoan
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a id-category-group="0" href="product-booth?id-category-group=0&id-category=0&page=1" class="menu-item nav-link px-4 rounded">
                                        Khuyến mãi
                                    </a>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a href="lien_he.jsp" class="menu-item nav-link px-4 rounded">
                                        Liên hệ
                                    </a>
                                </li>
                            </ul>
