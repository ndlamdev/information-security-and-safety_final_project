...
public class AddProductCartAction implements Action {
    public void action(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!cart.addProductCart(productId, modelId, quantity))
            response.getWriter().write(new JSONObject().put("message", "Lỗi").toString());
        else {
